...
public class StudentTestHashtableOpenAddressLinearProbing {
	...
	public void testInsert() {
		...
		assertEquals(-1, table2.indexOf(new HashtableElement(20))); // elemento que não existe
	}

	@Test(expected = HashtableOverflowException.class)
	public void testInsertFull() throws HashtableOverflowException{
		...
		table1.insert(new HashtableElement(11)); // levanta excessao pois está cheia 
	...
	public void testRemove() {
		...
		table2.remove(new HashtableElement(1));
	}
	...
	public void testSearch() {
		...
		assertNull(table1.search(new HashtableElement(15))); // elemento que nao
																// existe
		assertNull(table2.search(new HashtableElement(1))); // tabela vazia
		assertNull(table1.search(null));                    // elemento null
	}
